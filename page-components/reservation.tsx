        ...
        <div className="absolute top-0 left-0 right-0 overflow-hidden">
          <div className="flex whitespace-nowrap animate-marquee">
            {Array.from({ length: 20 }).map((_, i) => (
              <span key={i} className="text-zinc-800 text-sm font-light tracking-wider mx-8 py-4">
                OPENING TIMES
              </span>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <img src="/cocktail-martini.png" alt="Elegant martini cocktail" className="w-64 h-80 object-cover" />
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                <h3 className="text-zinc-800 font-medium text-lg mb-1">TUESDAY - THURSDAY</h3>
              ...
              <div>
                <h3 className="text-zinc-800 font-medium text-lg mb-1">SATURDAY</h3>
            ...
            <div className="flex justify-center lg:justify-start">
              <img src="/cocktail-red.png" alt="Red cocktails" className="w-64 h-64 object-cover" />
            </div>
          </div>
